<template lang="">
	<div class="payment-container" data-cy="payment-modal">
		<div class="modal-container">
			<p class="modal-container-cross" data-cy="token-modal-close" @click="$emit('closeModal')">X</p>
			<input
				type="number"
				data-cy="token-modal-input"
				id="tokens"
			...
			<button class="modal-container-submit" data-cy="token-modal-submit" @click="attemptPayment">

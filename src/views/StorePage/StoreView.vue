			...
			<nav class="content-header">
				...
				<div class="content-header-items">
					<div class="content-header-items-buttons">
						<p data-cy="nav-cart" @click="toggleCartModal">Cart</p>
						<Modal v-if="showCartModal" :isFavourites="false" />
					</div>

					<p class="content-header-items-buttons" data-cy="nav-tokens" @click="togglePaymentModal">Add tokens</p>

					<div class="content-header-items-buttons">
						<p data-cy="nav-favourites" @click="toggleFavouritesModal">Favourites</p>
						<Modal v-if="showFavouriteModal" :isFavourites="true" />
					</div>

					<p class="content-header-items-tokens">Tokens: <TokenCount /></p>
				</div>
			</nav>
			<div class="main">
...
import TokenCount from "./components/TokenCount/TokenCount.vue"
